...
const operationKeyMap: Record<string, string> = {
  ...
  "branch:upstream": "operationBranchUpstream",
  "branch:create": "operationBranchCreate",
  "branch:checkout": "operationBranchCheckout",
  "branch:checkout-remote": "operationBranchCheckoutRemote",
  "branch:checkout-remote:check": "operationBranchCheckoutRemote",
  "branch:checkout-remote:local": "operationBranchCheckoutRemote",
  "branch:upstream:set": "operationBranchUpstream",
